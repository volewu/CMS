...
insert  into `t_arctype`(`id`,`typeName`,`sortNo`,`keywords`,`description`) values (1,'Java基础',1,NULL,'55'),(2,'网页基础',2,'121','s '),(4,'Java建站',3,NULL,'6'),(5,'Java爬虫',4,NULL,'99'),(6,'网站SEO',9,NULL,NULL),(7,'广告联盟',6,NULL,NULL),(8,'Gakki',8,NULL,NULL);
...
insert  into `t_link`(`id`,`name`,`url`,`sortNo`) values (1,'测试1','http://www.java1234.com',1),(2,'测试2','http://www.java1234.com',2),(3,'测试3','http://www.java1234.com',3),(4,'测试4','http://www.java1234.com',4),(7,'测试2','http://www.wuvole.com',7),(9,'Linux','http://www.wuvole.com',9);
...
insert  into `t_manager`(`id`,`userName`,`password`) values (1,'gakki','7afe71dc32ca3f3ada0d7ff19d6c44fe');
